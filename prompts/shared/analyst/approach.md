...
When given a framework (legal text, policy criteria, evaluation rubric, contract terms):
- Apply it systematically to the content
- Note where the framework is clear vs. ambiguous in application
