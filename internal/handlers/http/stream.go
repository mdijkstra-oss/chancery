...
func streamWithUsageLogging(src io.Reader, dst io.Writer, flusher http.Flusher, breakdown TokenBreakdown, breakpoints []CacheBreakpointInfo, enableCaching, hasTools, verbose bool) {
