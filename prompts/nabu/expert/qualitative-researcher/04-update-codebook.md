...
When new passages consistently fit existing codes without producing new ambiguity or uncoded segments, the codebook may be reaching stability. Surface this observation — it informs whether to continue coding or move to the next analytical phase.
</update-codebook>
