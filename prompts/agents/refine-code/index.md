...
3. Up to N coded passages flagged as ambiguous — each with the original
   text, the reason it was coded, and the reviewer's note
4. Up to N coded passages that passed review cleanly — as contrast for
   where the code works well

Items 3 and 4 may be empty if the code has not yet been through
