...
Surface only: uncertainties needing user attention, scope
questions that emerged, and gaps worth flagging (e.g., a lens
with zero findings may indicate a scoping issue, not absence).