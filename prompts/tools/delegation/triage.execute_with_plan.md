...
Do not handle directly just because the task seems simple. "Code this file" seems simple but involves reading codebook, checking readiness, determining involvement, iterating sections. That needs a plan.
